# -*- coding: utf-8 -*-
"""Agentic_RAG_Agile_Task_Management.Streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/19KAG8bdhsWq2jNKmOqyO98JkwLCKO3MF
"""
...
# -----------------------------
st.set_page_config(page_title="Taiga Agentic RAG (LangGraph)", page_icon="🧩", layout="wide")
st.title("🧩 Taiga Agentic RAG (LangGraph + Streamlit)")
st.caption("Upload your preprocessed Taiga data, then chat with the Scrum Master assistant.")
...
def _ensure_documents(obj: Any) -> List[Document]:
    """
    Tries to convert various possible structures into List[Document].

    Supported (best-effort):
    - List[Document]
    - List[dict] with keys like: page_content, metadata
    - dict with key 'documents' as above
    - JSONL lines of dicts
    """
    if obj is None:
        return []

    # Case 1: already List[Document]
...
with st.sidebar:
    ...
    # Prefer secrets, fallback to input
    ...
    thread_id = st.text_input("Thread ID (memory key)", value=st.session_state.get("thread_id", "taiga-thread-1"))
